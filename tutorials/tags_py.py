...
class tags_py(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tags Tutorial")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tags Tutorial")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tags_py")
...
def main(top_block_cls=tags_py, options=None):
