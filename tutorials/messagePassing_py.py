...
class messagePassing_py(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Message Passing")
        ...
        self.settings = Qt.QSettings("GNU Radio", "messagePassing_py")
...
def main(top_block_cls=messagePassing_py, options=None):
