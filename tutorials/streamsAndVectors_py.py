...
class streamsAndVectors_py(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Streams and Vectors")
        ...
        self.settings = Qt.QSettings("GNU Radio", "streamsAndVectors_py")
...
def main(top_block_cls=streamsAndVectors_py, options=None):
