...
class HardwareTutorial_spectrum_sampler_py(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "HardwareTutorial_spectrum_sampler_py")
...
def main(top_block_cls=HardwareTutorial_spectrum_sampler_py, options=None):
