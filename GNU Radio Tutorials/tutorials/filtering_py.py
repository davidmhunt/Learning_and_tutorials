...
class filtering_py(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "filtering_py")
        ...
        self.lowPassFilterTaps = lowPassFilterTaps = firdes.low_pass(1.0, samp_rate, samp_rate/4,samp_rate/8, firdes.WIN_HAMMING, 6.76)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_lowPassFilterTaps(firdes.low_pass(1.0, self.samp_rate, self.samp_rate/4, self.samp_rate/8, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=filtering_py, options=None):
