...
# Title: Hardware Tutorial - FM Receiver
# Author: david
...
class HardwareTutorial_FM_Receiver_py(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Hardware Tutorial - FM Receiver")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Hardware Tutorial - FM Receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "HardwareTutorial_FM_Receiver_py")
        ...
        self.samp_rate = samp_rate = 2.5 * 1.92e6
        self.rf_decim = rf_decim = int(2.5 * 10)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 500e3, 600e3, firdes.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tuning, self.samp_rate)
...
def main(top_block_cls=HardwareTutorial_FM_Receiver_py, options=None):
