...
class hierBlocks_py(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "hier Blocks")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("hier Blocks")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hierBlocks_py")
...
def main(top_block_cls=hierBlocks_py, options=None):
